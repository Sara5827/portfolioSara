  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/portfolioSara" element={<HomeDarkAnimation />} />
...
// import React from "react";
// import HomeDarkAnimation from "../views/all-home-version/HomeDarkAnimation";  // Make sure the import is correct
// import { Routes, Route } from "react-router-dom";
// import ScrollTopBehaviour from "../components/ScrollTopBehaviour";
...
//         <Route path="/home-light-animation" element={<HomeLightAnimation />} />
//         <Route path="/home-light-rtl-animation" element={<HomeLightRtlAnimation />} />
//         <Route path="/dark-particle-effect" element={<HomeDarkParticles />} />
//         <Route path="/home-light-professional" element={<LightProfessionalAnimation />} />
//         <Route path="/home-light-professional-2" element={<HomeLightProfessional2 />} />
//         <Route path="/home-dark-animation" element={<HomeDarkAnimation />} />
//         <Route path="*" element={<NotFound />} />
//       </Routes>
//     </>
